...
export default function Button({ icon, label, onClick, variant = 'primary', size = 'medium', disabled = false, className = '', iconOnly = false }: ButtonProps) {
  let baseClass = 'rounded-md font-medium transition-colors';
  let variantClass = {
